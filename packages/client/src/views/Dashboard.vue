          ...
          <b-col>
            <b-card>
              <div class="card-block text-left">
                ...
                <span class="gutter-title1 row" v-if="activityFields.length === 0">Your agency has no recent activity.</span>
              </div>
          ...
          <b-col>
            <b-card>
              <div class="card-block text-left">
                ...
                <span class="gutter-title2 row" v-if="upcomingFields.length === 0">Your agency has no upcoming close dates.</span>
              </div>
