...
export default {
  ...
  actions: {
    fetchGrants({ commit }, {
      currentPage, perPage, orderBy, searchTerm, interestedByMe, assignedToAgency, aging, positiveInterest, rejected, interestedByAgency, opportunityStatuses, opportunityCategories, costSharing,
    }) {
