<template>
  <div>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown right v-if="loggedInUser">
            ...
            <b-dropdown-item-button href="#" @click="settingsClicked"
    ...
    <b-nav tabs justified style="margin-top: 20px">
      ...
      >
      <b-nav-item to="/my-grants" exact exact-active-class="active"
        >My Grants</b-nav-item
      >
      <b-nav-item to="/grants" exact exact-active-class="active"
        >Grants</b-nav-item
      >
      <b-nav-item to="/eligibility-codes" exact exact-active-class="active"
        >Eligibility Codes</b-nav-item
      >
      <b-nav-item to="/keywords" exact exact-active-class="active"
        >Keywords</b-nav-item
      >
      <b-nav-item
        to="/users"
        ...
        >Users</b-nav-item
      >
      <b-nav-item to="/Agencies" exact exact-active-class="active"
        >Agencies</b-nav-item
      >
    </b-nav>
