...
export default new Vuex.Store({
  ...
  modules: {},
  getters: {
    periodNames: (state) => _.map(state.reportingPeriods, 'name'),
    ...
    currentPeriodID: (state) => Number(state.applicationSettings.current_reporting_period_id),
    viewPeriodID: (state) => Number(state.viewPeriodID),
    viewPeriodIsCurrent: (state, getters) => getters.viewPeriodID === getters.currentPeriodID,
    currentReportingPeriod: (state, getters) => state.reportingPeriods.find((period) => period.id === getters.currentPeriodID),
    viewPeriod: (state, getters) => state.reportingPeriods.find((period) => period.id === getters.viewPeriodID),
