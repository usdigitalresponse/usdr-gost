...
const { ecCodes } = require('../../../../src/arpa_reporter/lib/arpa-ec-codes');
const {
    ...
    zip,
    zip4,
} = require('../../../../src/arpa_reporter/lib/format');
...
describe('server/lib/format', () => {
    ...
    describe('ec', () => {
        ...
        it('handles known ec codes', () => {
            ...
            expect(ec('ec3')).to.equal('3-Public Health-Negative Economic Impact: Public Sector Capacity');
