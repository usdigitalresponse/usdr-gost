    ...
    context('send passcode email', () => {
        it('calls the transport function with appropriate parameters', async () => {
            ...
            expect(_.omit(sendFake.firstCall.args[0], ['body'])).to.deep.equal({
                ...
                tags: ['notification_type=passcode', 'user_role=staff', 'organization_id=0', 'team_id=0', 'service=undefined', 'env=undefined', 'version=undefined'],
            });
    ...
    context('send welcome email', () => {
        it('calls the transport function with appropriate parameters', async () => {
            ...
            expect(_.omit(sendFake.firstCall.args[0], ['body'])).to.deep.equal({
                ...
                tags: ['notification_type=welcome', 'user_role=staff', 'organization_id=0', 'team_id=1', 'service=undefined', 'env=undefined', 'version=undefined'],
            });
        });
    });
            ...
            expect(sendFake.calledWithMatch(
                {
                    ...
                    tags: ['notification_type=grant_assignment', 'user_role=staff', 'organization_id=0', 'team_id=0', 'service=undefined', 'env=undefined', 'version=undefined'],
                },
            )).to.be.true;
            expect(sendFake.calledWithMatch(
                {
                    ...
                    tags: ['notification_type=grant_assignment', 'user_role=staff', 'organization_id=0', 'team_id=1', 'service=undefined', 'env=undefined', 'version=undefined'],
                },
            )).to.be.true;
            expect(sendFake.calledWithMatch(
                {
                    ...
                    subject: 'Grant Assigned to State Board of Accountancy',
                    tags: ['notification_type=grant_assignment', 'user_role=admin', 'organization_id=0', 'team_id=0', 'service=undefined', 'env=undefined', 'version=undefined'],
                },
            )).to.be.true;
        });
    ...
    context('buildAndSendGrantDigestEmails', () => {
        ...
        it('Sends an email for a user\'s saved search', async () => {
            ...
            expect(_.omit(sendFake.firstCall.args[0], ['body', 'text'])).to.deep.equal({
                ...
                tags: ['notification_type=grant_digest', 'user_role=admin', 'organization_id=0', 'team_id=0', 'service=undefined', 'env=undefined', 'version=undefined'],
            });
        });
