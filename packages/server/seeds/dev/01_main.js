...
exports.seed = async (knex) => {
    const tables = ['agency_eligibility_codes', 'keywords', 'grant_followers', 'eligibility_codes', 'grants', 'assigned_grants_agency', 'grants_interested', 'grants_saved_searches'];
